    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-gradient-to-br from-[#1a2e1a] to-[#0c1a0c] border-amber-500/30 text-white max-w-sm mx-auto">
        ...
        <div className="text-center py-6">
          ...
          <h2 className="text-2xl font-bold text-amber-400 mb-2">Gift Won!</h2>
          ...
          <p className="text-white/60 mb-6">
            Congratulationson winning item number #{winningNumber}!
          </p>
            ...
            {Array.from({ length: 30 }).map((_, i) => (
              <div
                ...
                style={{
                  ...
                  backgroundColor: ["#dc2626", "#16a34a", "#fbbf24", "#ffffff"][
